...
function StepperIndicator({ children, className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'relative flex items-center overflow-hidden justify-center size-8 shrink-0 border-2 border-white/20 bg-white/10 text-white rounded-full text-xs font-bold data-[state=completed]:bg-orange-500 data-[state=completed]:border-orange-500 data-[state=completed]:text-white data-[state=active]:bg-[#1e3a5f] data-[state=active]:border-orange-400 data-[state=active]:text-white',
        className,
      )}
    >
...
function StepperSeparator({ className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'm-0.5 rounded-full bg-white/20 group-data-[state=completed]/step:bg-orange-500 group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=horizontal]/stepper-nav:flex-1',
        className,
      )}
    />
  );
...
function StepperTitle({ children, className }: React.ComponentProps<'h3'>) {
  ...
  return (
    <h3 data-slot="stepper-title" data-state={state} className={cn('text-sm font-semibold leading-none text-white data-[state=inactive]:text-white/50', className)}>
      {children}
    </h3>
  );
}
...
function StepperDescription({ children, className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div data-slot="stepper-description" data-state={state} className={cn('text-xs text-white/50 data-[state=active]:text-white/80 data-[state=completed]:text-orange-300', className)}>
      {children}
    </div>
  );
}
